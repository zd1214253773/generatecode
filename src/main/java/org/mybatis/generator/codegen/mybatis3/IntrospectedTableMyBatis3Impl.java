...
import org.mybatis.generator.codegen.mybatis3.service.ControllerGenerator;
...
public class IntrospectedTableMyBatis3Impl extends IntrospectedTable {
    ...
    public void calculateGenerators(List<String> warnings,
        ...
        if(context.getJavaServiceGeneratorConfiguration() != null) {
            //service
            ServiceGenerator serviceGenerator = calculateServiceGenerator(javaClientGenerator, warnings, progressCallback);
            if(context.getJavaControllerGeneratorConfiguration() != null) {
                //controller
                calculateControllerGenerator(serviceGenerator, warnings, progressCallback);
            }
        }

    }

    protected void calculateControllerGenerator(ServiceGenerator serviceGenerator,
                                                              List<String> warnings,
                                                              ProgressCallback progressCallback) {
        AbstractJavaGenerator javaGenerator = new ControllerGenerator(serviceGenerator);
        initializeAbstractGenerator(javaGenerator, warnings,
                progressCallback);
        javaControllerGenerators.add(javaGenerator);
    }

    protected ServiceGenerator calculateServiceGenerator(AbstractJavaClientGenerator javaClientGenerator,
                                               List<String> warnings,
                                               ProgressCallback progressCallback) {
        //javaServiceGenerators
        ServiceGenerator javaGenerator = new ServiceGenerator(javaClientGenerator);
        initializeAbstractGenerator(javaGenerator, warnings,
                progressCallback);
    ...
    public List<GeneratedJavaFile> getGeneratedJavaFiles() {
        ...
        for (AbstractJavaGenerator javaGenerator : this.javaServiceGenerators) {
            List<CompilationUnit> compilationUnits = javaGenerator
                    .getCompilationUnits();
            for (CompilationUnit compilationUnit : compilationUnits) {
                GeneratedJavaFile gjf = new GeneratedJavaFile(compilationUnit,
        ...
        for (AbstractJavaGenerator javaGenerator : this.javaControllerGenerators) {
            List<CompilationUnit> compilationUnits = javaGenerator
                    .getCompilationUnits();
            for (CompilationUnit compilationUnit : compilationUnits) {
                GeneratedJavaFile gjf = new GeneratedJavaFile(compilationUnit,
