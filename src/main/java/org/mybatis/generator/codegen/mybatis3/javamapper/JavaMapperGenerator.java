...
public class JavaMapperGenerator extends AbstractJavaClientGenerator {
    ...
    protected void addlistByPage(Interface interfaze) {
        if (introspectedTable.getRules().generateListByPage()) {
            AbstractJavaMapperMethodGenerator methodGenerator = new ListByPageMethodGenerator();
