...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.ListByPageElementGenerator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected void addSelectByExampleWithoutBLOBsElement(
        ...
        if (introspectedTable.getRules().generateSelectByExampleWithoutBLOBs()) {
            AbstractXmlElementGenerator elementGenerator = new ListByPageElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
    ...
    protected void addListByPageElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateInsertSelective()) {
            AbstractXmlElementGenerator elementGenerator = new ListByPageElementGenerator();
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
