...
public class TopLevelClass extends InnerClass implements CompilationUnit{
    ...
    @Override
    public void addImportedTypes(List<String> importedTypes) {
        this.importedTypes.addAll(importedTypes.stream().map(s->new FullyQualifiedJavaType(s)).collect(Collectors.toSet()));
    }
