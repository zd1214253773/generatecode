...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        ATTR_LIST_BY_PAGE_STATEMENT_ID,
    ...
    public String getListByPageStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_LIST_BY_PAGE_STATEMENT_ID);
    }
    ...
    public void setQueryVoType(String queryVoType) {
        internalAttributes.put(InternalAttribute.ATTR_QUERY_VO_TYPE,
                queryVoType);
    }
    ...
    public String getQueryVoType() {
       return internalAttributes.get(InternalAttribute.ATTR_QUERY_VO_TYPE);
    }
    ...
    public boolean isProgressive() {
        Properties properties = context.getJavaServiceGeneratorConfiguration().getProperties();

        return isTrue(properties.getProperty(PropertyRegistry.PROGRESSIVE));
    }
    ...
    public String getBaseRecordShortName() {
       return this.getBaseRecordType().substring(this.getBaseRecordType().lastIndexOf(".") + 1);
    }
}
