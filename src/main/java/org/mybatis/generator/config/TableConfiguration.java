...
public class TableConfiguration extends PropertyHolder {
    ...
    private boolean listByPageStatementEnabled;
    ...
    public TableConfiguration(Context context) {
        ...
        listByPageStatementEnabled = true;
    }
    ...
    public boolean isListByPageStatementEnabled() {
        return listByPageStatementEnabled;
    }

    public void setListByPageStatementEnabled(boolean listByPageStatementEnabled) {
        this.listByPageStatementEnabled = listByPageStatementEnabled;
    }
}
