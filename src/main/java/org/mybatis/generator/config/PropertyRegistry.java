...
public class PropertyRegistry {
    ...
    public static final String QUERY_VOPACKAGE = "queryVOPackage"; //$NON-NLS-1$

    public static final String QUERY_VOSUPER_CLASS = "queryVOSuperClass"; //$NON-NLS-1$

    public static final String VO_PACKAGE = "voPackage"; //$NON-NLS-1$

    public static final String PROGRESSIVE = "progressive"; //$NON-NLS-1$
